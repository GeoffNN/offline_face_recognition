...
for i = 1:num_labels/2
    online_cover_state.centroids = [online_cover_state.centroids;preprocess_face(imread(sprintf('%s_%d.bmp','geoffrey',i)))];
    online_cover_state.Y = [online_cover_state.Y;1];
    online_cover_state.centroids = [online_cover_state.centroids;preprocess_face(imread(sprintf('%s_%d.bmp','jb',i)))];
    online_cover_state.Y = [online_cover_state.Y;-1];
end
