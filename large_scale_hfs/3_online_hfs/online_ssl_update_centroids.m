...
if (size(centroids,1) == max_num_centroids)
    ...
    [m, idx] = min(distances(:));
    [c_add, c_rep] = ind2sub(size(distances), idx);
    dx = min(1./ (exp(-pdist2(centroids,face,'euclidean') / (2*graph_param.sigma2)) + 1e-30));
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    id = (nodes_to_centroids_map == centroids_to_nodes_map(c_add));
    nodes_to_centroids_map(id) = centroids_to_nodes_map(c_rep);
